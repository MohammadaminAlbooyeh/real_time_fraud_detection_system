    ...
    <>
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b border-slate-800 px-6">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500 text-sm font-bold text-white">FD</span>
          <span className="text-base font-semibold text-white">Fraud Detection</span>
        </div>
        ...
        <div className="border-t border-slate-800 px-6 py-4">
          <p className="text-xs text-slate-500">Real-Time Fraud Detection</p>
